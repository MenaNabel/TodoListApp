...
namespace TodoListApp.Repository
{
    public class RepositoryAsync<T> : IRepositoryAsync<T> where T : class
    {
        ...
        public Task<TResult> SingleOrDefaultAsync<TResult>(Expression<Func<T, TResult>> selector,
        ...
        public bool UpdateNotAttach(T entity)
        {
            try
            {
                _dbContext.Entry(entity).State = EntityState.Detached;

                var UpdateQuery =  _dbSet.Update(entity);
